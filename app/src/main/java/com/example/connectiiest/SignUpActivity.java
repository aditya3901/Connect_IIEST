...
import com.example.connectiiest.databinding.ActivitySignUpBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(binding.etUsername.getText().toString().length() > 0 && binding.etEmail.getText().toString().length() > 0 && binding.etPassword.getText().toString().length() > 0){
                    progressDialog.show();
